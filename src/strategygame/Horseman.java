 ...
 * @author Youssef
 */
public class Horseman extends MovingAttackingUnit{
    private static int horsemenCreated, horsemenKilled;
//    Horse H;
    public GUI.Horseman AB;
    ...
    public Horseman(){
        ...
        shape.setIcon(new ImageIcon(new ImageIcon("Pics\\Civilizations\\1\\Horseman.png").getImage().getScaledInstance(width, height, Image.SCALE_SMOOTH)));
        Dot = new JLabel();
    ...
    public void create(CreatingBuildingUnit cbu){
        super.create(cbu);
        Civilization.myHorsemen.add(this);
        addToHorsemenCreated();;
    }
...
//                        Logger.getLogger(Horseman.class.getName()).log(Level.SEVERE, null, ex);
//                    }
//                }
//            }
//        }
//    }
    ...
    private void addToHorsemenCreated(){
        horsemenCreated++;
    }
    private void addToHorsemenKilled(){
        horsemenKilled++;
    }
}
